...
export type IsPlainObject<o> = o extends object ? (o extends string ? false : true) : false;

type test_1 = IsMatching<{ key: "value" }, { another_key: "value" }>; // false
type test_2 = IsMatching<{ foo: "bar" }, { foo: "bar" }>; // true

export type IsMatching<a, p> = unknown extends p
	? true
